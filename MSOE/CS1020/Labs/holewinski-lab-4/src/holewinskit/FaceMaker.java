...
public class FaceMaker extends Application {
    ...
    private Shape createHead() {
        ...
        return Menu.createShapeByShapeId(shapeID, "Head", xLeft, yBottom, HEAD_SIZE, HEAD_SIZE, Color.WHITE);
    }
    ...
    private Shape createRightEye() {
        ...
        return Menu.createShapeByShapeId(shapeID, "Right Eye", xLeft, yBottom, size, size, Color.WHITE);
    }
    ...
    private Shape createLeftEye() {
        ...
        return Menu.createShapeByShapeId(shapeID, "Left Eye", xLeft, yBottom, size, size, Color.WHITE);
    }
    ...
    private Shape createNose() {
        ...
        return Menu.createShapeByShapeId(shapeID, "Nose", xLeft, yBottom, size, size, Color.WHITE);
    }
    ...
    private Shape createMouth() {
        ...
        return Menu.createShapeByShapeId(shapeID, "Mouth", xLeft, yBottom, size, size, Color.WHITE);
    }
