...
public class Complex {
    ...
    public static Complex read(DataInputStream in){
    ...
    public static Complex read(Scanner in){
        double real = 0.0;
        double imag = 0.0;
        try{
            real = in.nextDouble();
    ...
    //Modify the Complex class so that it can be written to an ObjectOutputStream, and write a driver program that
    // creates four complex numbers: 1.0 + 0.0i, -2.3 - 5.0i, 0.0 + 3.0i, and 8.0 + 8.0i
    // and writes them to a binary file as objects.
